              ...
              {noVoiceForLang ? (
                ...
                <div className="relative">
                  <select
                    ...
                    className="h-11 w-full appearance-none rounded-2xl border border-border bg-gradient-to-b from-card to-background px-3 pr-9 text-sm outline-none transition-all focus:border-brand-1 focus:ring-2 focus:ring-brand-1/20 hover:border-border/80"
                  >
                    {langVoices.map((v) => (
